...
CONFIG_FRAMES_FACTOR = 20 # <<< EDIT THIS (if needed)
...
CONFIG_TEMP_DIR = "/mnt/nas/video_processing_temp_stage1/" # <<< EDIT THIS to a dedicated temp path for the video script

# --- CVAT Preparation Script Configuration ---
# Path to your script that prepares data for CVAT.
CONFIG_CVAT_PREP_SCRIPT_PATH = "/mnt/nas/TAmob/preprocessing_scripts/data2cvat.py" # <<< EDIT THIS (Path to the script you provided)
# List of class names for CVAT (e.g., ['car', 'person', 'truck'])
CONFIG_CVAT_CLASSES = ["car", "motorcycle", "bus", "truck", "bicycle", "scooter"] # <<< EDIT THIS
# Subset for CVAT: 'Train' or 'Validation'
CONFIG_CVAT_SUBSET = "Train" # <<< EDIT THIS ('Train' or 'Validation')
# Set to True to run the CVAT preparation step, False to skip it.
CONFIG_RUN_CVAT_PREP = True # <<< EDIT THIS (True/False)
