    ...
    for split in splits:
        ...
        if not os.path.exists(source_images_path):
            ...
            if limit > 0 and limit < len(image_files):
                ...
                continue  # Skip copying images if limit is set to 0
            else:
...
src_directory = "/mnt/nas/TAmob/old_data/final_extracted_frames/23_05_2025 19_59_59 (UTC+03_00)_processed_fr5_10_197_21_24/_relabeled_split/"
